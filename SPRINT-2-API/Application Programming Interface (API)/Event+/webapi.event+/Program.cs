...
//habilita o serviço de moderador de conteúdo Azure
builder.Services.AddSingleton(provider => new ContentModeratorClient(
    new ApiKeyServiceClientCredentials("d4192e65f40a4171b8ea2bac8017630a"))
    {
        Endpoint = "https://eventcontentmoderatorvinicius.cognitiveservices.azure.com/"
    }
    );
